...
public class SimpleCORSFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		responseToUse.setHeader("Access-Control-Allow-Methods", "GET,POST,PUT,PATCH,DELETE");
		responseToUse.setHeader("Access-Control-Allow-Headers", "Orgin,X-Requested-With,Content-Type,Accept,x-auth,value");
